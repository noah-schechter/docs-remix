...
4. **Collaboration—** We’ve baked in key project-management tools right into the platform. While Atlos workspaces are private by default, [sharing](/docs/collaboration#how-to-add-a-member) a project is just as easy as sending a Google Doc: Investigators simply add a collaborator’s username and choose from several fine-grained permission levels.
